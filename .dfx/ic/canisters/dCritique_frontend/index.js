...
import { idlFactory } from './dCritique_frontend.did.js';
export { idlFactory } from './dCritique_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.DCRITIQUE_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./dCritique_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the dCritique_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./dCritique_frontend.did.js")._SERVICE>}
 */
export const dCritique_frontend = createActor(canisterId);
