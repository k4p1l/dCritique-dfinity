...
import { idlFactory } from './dCritique_backend.did.js';
export { idlFactory } from './dCritique_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.DCRITIQUE_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./dCritique_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the dCritique_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./dCritique_backend.did.js")._SERVICE>}
 */
export const dCritique_backend = createActor(canisterId);
